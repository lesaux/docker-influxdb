lesaux-docker-influxdb
=====================
InfluxDB image inspired by tutum/influxdb. The graphite input plugin has been enabled.
...
Start your image binding the external ports `8083` and `8086` in all interfaces to your container. Ports `8090` and `8099` are only used for clustering and should not be exposed to the internet.
    ...
    docker run -d -p 8083:8083 -p 8086:8086 --expose 8090 --expose 8099 lesaux/influxdb
...
```docker run -d -p 8083:8083 -p 8084:8084 -e PRE_CREATE_DB="db1;db2;db3" lesaux/influxdb:latest``` 
...
```docker run -d -p 8083:8083 -p 8086:8086 --expose 8090 --expose 8099 --expose 4444 -e UDP_DB="my_db" lesaux/influxdb```
...
docker run -p 8083:8083 -p 8086:8086 --expose 8090 --expose 8099 \
  ...
  -d --name masterinflux lesaux/influxdb
```
